...
public class DatabaseHelper {
	...
	// Database Name
	private static final String DATABASE_NAME = "ddjSongManager";
	...
	private static final String KEY_LAST_PLAYED_ON = "lastPlayedOn";

	// USER table - column names
	private static final String KEY_USER_TABLE_SONG_ID = "songId";
	private static final String KEY_USER_VOTE = "vote";

	// Table Create Statements
	// Todo table create statement
	private static final String CREATE_TABLE_SONG = "CREATE TABLE "
			+ TABLE_SONG + "(" + KEY_ID + " INTEGER PRIMARY KEY," + KEY_TODO
	...
	/**
	 * Find if table exists; useful for the every time the app runs, so that we do not try to create multiple tables
	 * @param tableName
	 * @param openDb
	 * @return true if table already exists else false
	 */
